...
public class secProjectAct extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sec_project);
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<secProjectAct> mActivity;
        int mCounter = 0;
        public ContohLoader(@NonNull Context context, int n,
                          secProjectAct main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<secProjectAct>(main);
        }
        @Nullable
        @Override
